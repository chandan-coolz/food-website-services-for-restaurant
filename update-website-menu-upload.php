...
$target_dir = "update menu uploads/";
...
$sql5 = "DELETE FROM update_menu_pic  WHERE merchant_email='$email'";
...
$sql3 = "SELECT * FROM update_menu_pic where merchant_email='$email' and src='$target_file' ";
...
$sql = "INSERT INTO update_menu_pic(merchant_email,src,date,served)
