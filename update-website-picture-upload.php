...
try {
$target_dir = "update website upload/";
...
$sql2 = "DELETE FROM update_website_pic  WHERE merchant_email='$email'";
$conn->query($sql2);



$sql = "INSERT INTO update_website_pic(merchant_email,src,date,served)
